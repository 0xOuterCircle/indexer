...
var Dao = entityQuerySet{
    ...
    Get: `select creator, parent, registry, governance from dao where id = $1`,
    Aggregate: `select count(*) over() as total, id, creator, parent, registry, governance from dao where environment = $1 offset $2 limit $3`,
